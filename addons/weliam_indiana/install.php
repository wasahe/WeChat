...
-- ----------------------------
-- Table structure for ims_weliam_indiana_cartsetting
-- ----------------------------
DROP TABLE IF EXISTS `ims_weliam_indiana_cartsetting`;
CREATE TABLE `ims_weliam_indiana_cartsetting` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `num` int(11) NOT NULL,
  `is_show` int(11) NOT NULL,
  `type` int(11) NOT NULL,
  `allnum` varchar(225) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of ims_weliam_indiana_cartsetting
-- ----------------------------
...
-- ----------------------------
-- Table structure for ims_weliam_indiana_discuss
-- ----------------------------
DROP TABLE IF EXISTS `ims_weliam_indiana_discuss`;
CREATE TABLE `ims_weliam_indiana_discuss` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_weliam_indiana_discuss
-- ----------------------------
...
-- ----------------------------
-- Table structure for ims_weliam_indiana_in
-- ----------------------------
DROP TABLE IF EXISTS `ims_weliam_indiana_in`;
CREATE TABLE `ims_weliam_indiana_in` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '唯一标识',
  `data` varchar(50) NOT NULL COMMENT '机器人数据',
  `type` int(11) NOT NULL,
  `uniacid` int(11) NOT NULL,
  KEY `indx_displayorder` (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2263 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of ims_weliam_indiana_in
-- ----------------------------
...
-- ----------------------------
-- Table structure for ims_weliam_indiana_login_session
-- ----------------------------
DROP TABLE IF EXISTS `ims_weliam_indiana_login_session`;
CREATE TABLE `ims_weliam_indiana_login_session` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_weliam_indiana_login_session
-- ----------------------------
...
-- ----------------------------
-- Table structure for ims_weliam_indiana_notice
-- ----------------------------
DROP TABLE IF EXISTS `ims_weliam_indiana_notice`;
CREATE TABLE `ims_weliam_indiana_notice` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '唯一标识',
  `uniacid` int(11) NOT NULL,
...
-- ----------------------------
-- Records of ims_weliam_indiana_notice
-- ----------------------------
...
-- ----------------------------
-- Table structure for ims_weliam_indiana_setting
-- ----------------------------
DROP TABLE IF EXISTS `ims_weliam_indiana_setting`;
CREATE TABLE `ims_weliam_indiana_setting` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
...
-- ----------------------------
-- Records of ims_weliam_indiana_setting
-- ----------------------------
...
-- ----------------------------
-- Table structure for ims_weliam_indiana_smstpl
-- ----------------------------
DROP TABLE IF EXISTS `ims_weliam_indiana_smstpl`;
CREATE TABLE `ims_weliam_indiana_smstpl` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `name` varchar(50) NOT NULL,
...
-- ----------------------------
-- Records of ims_weliam_indiana_smstpl
-- ----------------------------

-- ----------------------------
-- Table structure for ims_weliam_indiana_syssetting
-- ----------------------------
DROP TABLE IF EXISTS `ims_weliam_indiana_syssetting`;
CREATE TABLE `ims_weliam_indiana_syssetting` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ims_weliam_indiana_syssetting
-- ----------------------------
