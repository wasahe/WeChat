!function(a, b, c) {
    ...
    function e(b) {
        ...
        if (a.debuging && c && c.log && "pbReport" !== b.method)
            try {
                c.log(b)
            } catch (d) {}
    }
    function f(b, c, d, e, f) {
        if (b && c && d) {
            ...
            !f || !M[f] && !window[f])
                ...
                i = e.length; i > h; h++)
                    if (g = e[h],
                    a.isObject(g) && (g = g.callbackName || g.callback),
                    g && (M[g] || window[g])) {
                        f = g;
                        break
                    }
            ...
            j = String(f).match(/__MQQ_CALLBACK_(\d+)/),
            j && (N[j[1]] = N[f])),
            B.send(k, R)
        }
    }
    ...
    function h(b, c, d) {
        var e, f;
        return (b = a.isFunction(b) ? b : window[b]) ? (e = i(b),
        f = "__MQQ_CALLBACK_" + e,
        window[f] = function() {
    ...
    function k(d, f, g, h) {
        var i, k, l, m = a.isFunction(d) ? d : M[d] || window[d], n = Date.now();
        f = f || [],
        i = f[0],
        a.isUndefined(h) && (h = !0),
        a.isObject(i) && ("data" in i || (i.data = c({}, i)),
        "code" in i || (i.code = j(i) || 0),
        i.msg = i.msg || ""),
        a.isFunction(m) ? h ? setTimeout(function() {
            m.apply(null , f)
        }, 0) : m.apply(null , f) : console.log("mqqapi: not found such callback: " + d),
        g && (delete M[d],
        delete window["__MQQ_CALLBACK_" + d]),
        N[d] && (l = N[d],
        delete N[d],
        e({
            from: "fireCallback",
        ...
        Number(d) && delete N["__MQQ_CALLBACK_" + d],
        i && (i.code !== b ? k = i.code : /^-?\d+$/.test(String(i)) && (k = i)),
        B.send(l.uri + "#callback", k, n - l.startTime))
    }
    function l(b) {
    ...
    function o(b) {
        var c, d, e = b.split("."), f = e[e.length - 2] + "." + e[e.length - 1];
        return c = O[f] || O[b.replace("qw.", "mqq.").replace("qa.", "mqq.")],
        a.isObject(c) && (c = c[a.iOS ? "iOS" : a.android ? "android" : "browser"]),
        c ? (d = c.split("-"),
        1 === d.length ? a.compare(d[0]) > -1 : a.compare(d[0]) > -1 && a.compare(d[1]) < 1) : !1
    }
    function p(c, d, f, g) {
        function h() {
            l(g, {
    ...
    function q(b, c) {
        if ("AndroidQQ" === a.platform) {
            if (a.compare("4.7.2") < 0)
                return !0;
            if (S[b] && a.compare(S[b]) < 0)
                return !0
        }
        return !1
    }
    function r(c, d, e, g) {
        if (!c || !d || window !== window.top)
            return null ;
        var h, j, l, m;
        if (l = E.call(arguments, 2),
        g = l.length && l[l.length - 1],
        a.isFunction(g) ? l.pop() : a.isUndefined(g) ? l.pop() : g = null ,
        e = l[0],
        j = i(g),
        -1 === T.indexOf(d) && f("jsbridge", c, d, l, j),
        g && a.isObject(e) && !e.callback && (window["__MQQ_CALLBACK_AUTO_" + j] = g,
        e.callback = "__MQQ_CALLBACK_AUTO_" + j),
        q(c, d))
            if (a.compare("4.5") > -1 || /_NZ\b/.test(C))
                h = "jsbridge://" + encodeURIComponent(c) + "/" + encodeURIComponent(d) + "/" + j,
                ...
                if (m = window[c][d].apply(window[c], l),
                !g)
                    return m;
                k(j, [m])
            } else
                g && k(j, [a.ERROR_NO_SUCH_METHOD]);
        else if (h = "jsbridge://" + encodeURIComponent(c) + "/" + encodeURIComponent(d),
    ...
    function t(b, c, d, e, g) {
        ...
        a.isFunction(k[k.length - 1]) ? (g = k[k.length - 1],
        k.pop()) : g = null ,
        e = 4 === k.length ? k[k.length - 1] : {},
        g && (e.callback_type = "javascript",
        i = h(g),
        e.callback_name = i),
    ...
    function u(a) {
        var b, c, d, e, f = a.indexOf("?"), g = a.substring(f + 1).split("&"), h = {};
        for (b = 0; b < g.length; b++)
            e = g[b],
            f = e.indexOf("="),
            -1 === f ? h[e] = "" : (c = e.substring(0, f),
            d = e.substring(f + 1),
            h[c] = decodeURIComponent(d));
        return h
    }
    function v(a) {
        var b, c, d = [];
        for (b in a)
            a.hasOwnProperty(b) && (b = String(b),
            c = String(a[b]),
            "" === b ? d.push(c) : d.push(b + "=" + encodeURIComponent(c)));
        return d.join("&")
    }
    function w(a, b) {
        var c, d = document.createElement("a");
        return d.href = a,
        d.search && (c = u(String(d.search).substring(1)),
    ...
    function x(a, b) {
        if ("qbrowserVisibilityChange" === a)
            return document.addEventListener(a, b, !1),
            !0;
        var c = "evt-" + a;
    ...
    function A(b, c, d) {
        ...
        a.android && g.options.broadcast === !1 && a.compare("5.2") <= 0 && (g.options.domains = ["localhost"],
        g.options.broadcast = !0),
        "browser" !== a.platform && (e = "jsbridge://event/dispatchEvent?p=" + encodeURIComponent(JSON.stringify(g) || ""),
        p(e, "event", "dispatchEvent"),
        f("jsbridge", "event", "dispatchEvent"))
    }
    var B, C = navigator.userAgent, D = window.MQQfirebug, E = Array.prototype.slice, F = Object.prototype.toString, G = /\b(iPad|iPhone|iPod)\b.*? OS ([\d_]+)/, H = /\bAndroid([^;]+)/, I = /\bQQ\/([\d\.]+)/, J = /\bIPadQQ\/([\d\.]+).*?\bQQ\/([\d\.]+)/, K = /\bV1_AND_SQI?_([\d\.]+)(.*? QQ\/([\d\.]+))?/, L = /\bTribe\/([\d\.]+)/, M = a.__aCallbacks || {}, N = a.__aReports || {}, O = a.__aSupports || {}, P = a.__aFunctions || {}, Q = 1, R = -1e5, S = {
        qbizApi: "5.0",
        pay: "999999",
    ...
    }, T = ["pbReport", "popBack", "close", "qqVersion"];
    return D ? (a.debuging = !0,
    C = D.ua || C) : a.debuging = !1,
    c(a, function() {
        var a = {}
    ...
    a.platform = function() {
        var c, e, f = "browser";
        return a.android && ((c = C.match(K)) && c.length ? (a.QQVersion = a.clientVersion = (d(c[1], c[3]) >= 0 ? c[1] : c[3]) || "0",
        f = "AndroidQQ") : (c = C.match(L)) && c.length && (a.clientVersion = c[1] || "0",
        f = "AndroidTribe"),
        window.JsBridge = window.JsBridge || {},
        window.JsBridge.callMethod = r,
        window.JsBridge.callback = l,
        window.JsBridge.compareVersion = a.compare),
        a.iOS && (a.__RETURN_VALUE = b,
        (c = C.match(J)) && c.length ? (a.clientVersion = c[1] || "0",
        a.QQVersion = c[2] || a.clientVersion,
        f = "iPadQQ") : (c = C.match(I)) && c.length ? (a.QQVersion = a.clientVersion = c[1] || "0",
        f = "iPhoneQQ") : (c = C.match(L)) && c.length ? (a.clientVersion = c[1] || "0",
        f = "iOSTribe") : (e = r("device", "qqVersion"),
        e && (a.QQVersion = a.clientVersion = e,
        f = "iPhoneQQ")),
        window.iOSQQApi = a),
        f
    }(),
    ...
    B = function() {
        function b() {
            ...
            k.typeid = i,
            k.releaseversion = l,
            k.sdkversion = a.version,
            k.qua = m,
            k.frequency = j,
            k.t = Date.now(),
            k.key = ["commandid", "resultcode", "tmcost"].join(","),
            ...
            k = new String(v(k)),
            a.compare("4.6") >= 0 ? setTimeout(function() {
            ...
            ,
            c.src = "http://wspeed.qq.com/w.cgi?" + k),
            f = setTimeout(b, e))
        }
        function c(a, c, h) {
            var i;
...
function(a) {
        ...
        return c ? function() {
         ...
         : function() {
            var c = d.call(arguments)
              , e = null ;
            c.length && "function" == typeof c[c.length - 1] && (e = c[c.length - 1],
            c.pop());
    ...
    function c(a, c) {
        ...
        for (var d in a) {
            ...
            if (e && e.length && Array.isArray(e)) {
                var f = window[d];
                if (f)
                    "object" == typeof f && f.getClass && (l[d] = f,
                    window[d] = {});
                else {
                    if (!k)
                        continue;window[d] = {}
    ...
    var d = Array.prototype.slice
      ...
      , l = {};
    window.JsBridge || (window.JsBridge = {}),
    window.JsBridge.restoreApis = c,
    c(e),
    c(f, "4.5"),
    k ? /\bPA\b/.test(j) || mqq.compare("4.6") >= 0 ? (c(g),
    c(h, "4.5"),
    c(i, "4.5")) : /\bQR\b/.test(j) && (c(i, "4.5"),
...
mqq.build("mqq.app.checkAppInstalledBatch", {
    android: function(a, b) {
        a = a.join("|"),
        mqq.invokeClient("QQApi", "checkAppInstalledBatch", a, function(a) {
            a = (a || "").split("|"),
            b(a)
        })
    },
...
mqq.build("mqq.app.downloadApp", {
    android: function() {
        ...
        return function(e, f) {
            !a && f && (a = !0,
            mqq.invokeClient("q_download", "registerDownloadCallBackListener", mqq.callback(d))),
...
mqq.build("mqq.app.isAppInstalledBatch", {
    ...
    android: function(a, b) {
        a = a.join("|"),
        mqq.invokeClient("QQApi", "isAppInstalledBatch", a, function(a) {
            var c = [];
            a = (a + "").split("|");
            for (var d = 0; d < a.length; d++)
                c.push(1 === parseInt(a[d]));
            b(c)
        })
    },
    supportInvoke: !0,
    ...
    mqq.build("mqq.data.fetchJson", {
        ...
        android: function(c, d) {
            ...
            e.timeout && (c.timer = setTimeout(function() {
                c.callback && (c.callback("timeout", c.context || window, 0),
                c.callback = null )
            }, e.timeout)),
    ...
    var a = function(a) {
      ...
      , b = function(b) {
        if (mqq.compare("4.7.1") >= 0)
            mqq.invokeClient("qw_data", "getPerformance", a(b));
        else
            try {
...
function() {
    var a, b = {}, c = "object" == typeof tbs_bridge && "function" == typeof tbs_bridge.nativeExec, d = c ? tbs_bridge : null , e = function() {}
    , f = function(a) {
        !b[a] && c && (d.nativeExec("debug", "subscribeChanged", 1, '{"numHandlers":1,"type":"' + a + '"}'),
        b[a] = [])
    }
    , g = function(e, f) {
        var g = b[e];
        g && g.push(f),
        !a && c && (d.fireEvent = function(a, c) {
            var d, e;
            a = a || "";
            var f = b[a];
            if (f && f.length > 0) {
...
mqq.build("mqq.data.ssoRequest", {
    iOS: function(a, b) {
        ...
        a.callback = mqq.callback(b),
        mqq.invokeClient("sso", "sendRequest", a)
    },
    android: function(a, b) {
        a.data = JSON.stringify(a.data || {}),
        a.callback = mqq.callback(b),
...
mqq.build("mqq.data.startSyncData", {
    iOS: function(a, b) {
        ...
        c && (a.callback = c,
        mqq.invokeClient("data", "startSyncData", a))
    },
    android: function(a, b) {
        var c = mqq.callback(b);
...
mqq.build("mqq.data.writeH5Data", {
    ...
    android: function(a, b) {
        var c = a.data;
        c && ("object" == typeof c && (c = JSON.stringify(c)),
        a.data = encodeURIComponent(c)),
        mqq.invokeClient("publicAccount", "writeH5Data", a, mqq.callback(b || function() {}
        , !0))
    },
    supportInvoke: !0,
    support: {
...
function() {
    var a = function(a) {
      ...
      , b = function(b, c) {
        var d, e, f = a(b);
        return "object" === f && mqq.compare("5.8.0") >= 0 ? (d = {},
        d.id = "webviewDebugLog_" + b.id,
        d.subid = b.subid,
        d.content = b.content,
        d.isall = !1,
        "string" === a(b.level) && (e = b.level.toLowerCase(),
        ("debug" == e || "info" == e || "error" == e) && (d.level = e)),
        d.level = d.level || "info",
        d.content = d.content ? d.content : "",
        d.content = d.level + "|" + d.content,
        "error" == d.level && (d.isall = !0),
        mqq.invokeClient("qw_debug", "detailLog", d)) : void 0
    }
    ;
...
mqq.build("mqq.debug.hide", {
    iOS: function(a) {
        return mqq.compare("4.7.1") >= 0 ? (null  == a && (a = !0),
        mqq.invokeClient("qw_debug", "hide", {
            flag: a
        })) : void 0
    },
    android: function(a) {
...
mqq.build("mqq.debug.show", {
    iOS: function(a) {
        return mqq.compare("4.7.1") >= 0 ? (null  == a && (a = !0),
        mqq.invokeClient("qw_debug", "show", {
            flag: a
        })) : void 0
    },
    android: function(a) {
        mqq.compare("4.7.1") >= 0 && (null  == a && (a = !0),
        mqq.invokeClient("qw_debug", "show", {
            flag: a
        }))
    },
...
mqq.build("mqq.device.getDeviceInfo", {
    iOS: function(a) {
        if (mqq.compare(4.7) >= 0)
            return mqq.invokeClient("device", "getDeviceInfo", a);
...
function() {
    function a(a, c) {
        ...
        a && "radio" in a && (1 === a.type ? a.radio = "wifi" : a.type >= 2 ? a.radio = b[a.radio] || a.radio : a.radio = "unknown"),
        c && c(a)
    }
    var b = {
...
mqq.build("mqq.device.getWebViewType", {
    ...
    android: function(a) {
        ...
        return /\bPA\b/.test(c) ? (b = 5,
        /\bCoupon\b/.test(c) ? b = 2 : /\bMyCoupon\b/.test(c) && (b = 3)) : /\bQR\b/.test(c) && (b = 4),
...
mqq.build("mqq.media.getPicture", {
    iOS: function(a, b) {
        !a.outMaxWidth && a.maxWidth && (a.outMaxWidth = a.maxWidth,
        delete a.maxWidth),
        !a.outMaxHeight && a.maxHeight && (a.outMaxHeight = a.maxHeight,
        delete a.maxHeight),
...
mqq.build("mqq.offline.checkUpdate", {
    iOS: function(a, b) {
        ...
        c && (a.callback = c,
        mqq.invokeClient("offline", "checkUpdate", a))
    },
    android: function(a, b) {
...
mqq.build("mqq.offline.downloadUpdate", {
    iOS: function(a, b) {
        ...
        c && (a.callback = c,
        mqq.invokeClient("offline", "downloadUpdate", a))
    },
    android: function(a, b) {
        var c = mqq.callback(b, !1);
...
mqq.build("mqq.offline.isCached", {
    iOS: function(a, b) {
        var c = mqq.callback(b);
        c && (a.callback = c,
        mqq.invokeClient("offline", "isCached", a))
    },
    android: function(a, b) {
...
function() {
    function a(a) {
        var b = null ;
        if (e === !1 && (e = "" == location.search ? "" == location.hash ? "" : location.hash.substring(1) : location.search.substring(1),
        e = e.split("&"),
        e.length > 0))
    ...
    function d(a, b) {
        if (0 == a.code) {
            var c = {
              ...
              , d = a.data.buffer;
            if (d = "object" != typeof d && "" != d ? JSON.parse(d) : d,
            "undefined" != typeof d.msg)
                for (var e in d.msg)
                    1 == d.msg[e].stat && c.count++;
            l[b].call(null , c)
        } else
            l[b].call(null , {
                ret: a.code,
    ...
    mqq.build("mqq.redpoint.getNewMsgCnt", {
        iOS: function(a, e) {
            ...
            if (l[f] = e,
            k)
                mqq.redpoint.getAppInfo(a, function(a) {
                    d(a, f)
                });
            else {
                if (!Zepto)
        ...
        if (0 == a.code) {
            ...
            "undefined" != typeof d.msg) {
                for (var f in d.msg)
                    ...
                    d.msg[f].stat = 2);
                if (a.data.buffer = JSON.stringify(d),
                e.length > 0) {
                    c.list = e,
...
function() {
    var a = function(a, b) {
        ...
        mqq.redpoint.isEnterFromRedPoint({
            ...
            0 == c.code && 1 == c.data ? (b && (a.callback = mqq.callback(b, !0)),
            mqq.invokeClient("redpoint", "reportBusinessRedTouch", a)) : (b({
                code: -1,
    ...
    var a = function(a) {
        return function(b, c, d) {
            ...
            if (0 === b) {
                ...
                1 === b || -1 === b ? (f.retmsg = "用户主动放弃支付",
                f.resultCode = -1) : f.retmsg = c;
            a && a(f)
        }
    }
    ;
...
mqq.build("mqq.ui.openUrl", {
    iOS: function(a) {
        a || (a = {}),
        2 === a.target ? mqq.invokeClient("nav", "openLinkInSafari", {
            url: a.url
        }) : 1 === a.target ? (a.styleCode = {
            1: 4,
            2: 2,
            3: 5
        }[a.style] || 1,
    ...
    android: function(a) {
        a || (a = {}),
        2 === a.target ? mqq.compare("4.6") >= 0 ? mqq.invokeClient("publicAccount", "openInExternalBrowser", a.url) : mqq.compare("4.5") >= 0 && mqq.invokeClient("openUrlApi", "openUrl", a.url) : 1 === a.target ? (a.style || (a.style = 0),
        mqq.compare("4.7") >= 0 ? mqq.invokeClient("ui", "openUrl", {
            url: a.url,
            options: a
        }) : mqq.compare("4.6") >= 0 ? mqq.invokeClient("qbizApi", "openLinkInNewWebView", a.url, a.style) : mqq.compare("4.5") >= 0 ? mqq.invokeClient("publicAccount", "openUrl", a.url) : window.open(a.url, "_self")) : window.open(a.url, "_self")
    },
    browser: function(a) {
        a || (a = {}),
        2 === a.target ? window.open(a.url, "_blank") : window.open(a.url, "_self")
    },
    supportInvoke: !0,
    support: {
        iOS: "4.5",
...
mqq.build("mqq.ui.setActionButton", {
    ...
    android: function(a, b) {
        var c = mqq.callback(b);
        a.hidden && (a.title = ""),
        mqq.compare("4.7") >= 0 ? (a.callback = c,
        mqq.invokeClient("ui", "setActionButton", a)) : mqq.invokeClient("publicAccount", "setRightButton", a.title, "", c || null )
    },
    supportInvoke: !0,
    support: {
        iOS: "4.6",
...
mqq.build("mqq.ui.setLoading", {
    iOS: function(a) {
        a && (a.visible === !0 ? mqq.invokeClient("nav", "showLoading") : a.visible === !1 && mqq.invokeClient("nav", "hideLoading"),
        a.color && mqq.invokeClient("nav", "setLoadingColor", {
            r: a.color[0],
            g: a.color[1],
            b: a.color[2]
        }))
...
mqq.build("mqq.ui.setTitleButtons", {
    iOS: function(a) {
        ...
        b.callback && mqq.invokeClient("ui", "setOnCloseHandler", b)),
        c && mqq.invokeClient("nav", "setActionButton", c))
    },
    android: function(a) {
        var b = a.left
          , c = a.right;
        b && (b.callback = mqq.callback(b.callback)),
        c && (c.callback = mqq.callback(c.callback)),
        mqq.compare("5.3") >= 0 ? mqq.invokeClient("ui", "setTitleButtons", a) : (b && b.callback && mqq.invokeClient("ui", "setOnCloseHandler", b),
        c && (c.hidden && (c.title = ""),
        mqq.compare("4.7") >= 0 ? mqq.invokeClient("ui", "setActionButton", c) : mqq.invokeClient("publicAccount", "setRightButton", c.title, "", c.callback)))
    },
    supportInvoke: !0,
    support: {
        iOS: "5.0",
...
mqq.build("mqq.ui.shareMessage", {
    iOS: function(a, b) {
        !("needPopBack" in a) && "back" in a && (a.needPopBack = a.back),
        a.share_url && (a.share_url = mqq.removeQuery(a.share_url, ["sid", "3g_sid"])),
        a.desc && (a.desc = a.desc.length > 50 ? a.desc.substring(0, 50) + "..." : a.desc),
        a.toUin && (a.toUin += ""),
    ...
    android: function(a, b) {
        if (a.share_url && (a.share_url = mqq.removeQuery(a.share_url, ["sid", "3g_sid"])),
        a.callback = mqq.callback(function(a) {
            b && b({
                retCode: a ? 0 : 1
            })
        ...
        a.desc && (a.desc = a.desc.length > 50 ? a.desc.substring(0, 50) + "..." : a.desc),
        a.srcName && (a.sourceName = a.srcName),
        a.share_type && (2 === a.share_type || 3 === a.share_type) && mqq.compare("5.2") < 0 && mqq.support("mqq.app.isAppInstalled")) {
...
mqq.build("mqq.ui.shareRichMessage", {
    ...
    android: function(a, b) {
        ...
        a.desc = a.desc || a.summary,
        a.desc && (a.desc = a.desc.length > 50 ? a.desc.substring(0, 50) + "..." : a.desc),
        mqq.compare("5.0") >= 0 ? (a.share_url = a.share_url || a.targetUrl,
        a.image_url = a.image_url || a.imageUrl,
        a.share_url && (a.share_url = mqq.removeQuery(a.share_url, ["sid", "3g_sid"])),
        a.callback = b ? mqq.callback(function(a) {
            b({
                ret: a ? 0 : 1
            })
        }) : null ,
        mqq.invokeClient("QQApi", "shareMsg", a)) : (a.targetUrl = a.targetUrl || a.share_url,
        a.imageUrl = a.imageUrl || a.image_url,
        a.targetUrl && (a.targetUrl = mqq.removeQuery(a.targetUrl, ["sid", "3g_sid"])),
        a.callback = mqq.callback(b),
        mqq.invokeClient("publicAccount", "officalAccountShareRichMsg2QQ", a))
    },
    supportInvoke: !0,
    support: {
        iOS: "4.7",
...
mqq.build("mqq.ui.showDialog", {
    iOS: function(a, b) {
        a && (a.callback = mqq.callback(b, !0),
        a.title = a.title + "",
        a.text = a.text + "",
        "needOkBtn" in a || (a.needOkBtn = !0),
        "needCancelBtn" in a || (a.needCancelBtn = !0),
        a.okBtnStr = a.okBtnText,
        a.cancelBtnStr = a.cancelBtnText,
        mqq.invokeClient("nav", "showDialog", a))
    },
    android: function(a, b) {
...
mqq.build("mqq.ui.showOfficialAccountProfile", {
    iOS: function(a) {
        mqq.compare("6.0") >= 0 ? mqq.invokeClient("publicAccount", "showOfficialAccountProfile", a) : (a.showAIO = !1,
        mqq.invokeClient("nav", "showOfficalAccountDetail", a))
    },
    android: function(a) {
...
mqq.build("mqq.ui.showProfile", {
    iOS: function(a) {
        mqq.compare("4.7") >= 0 ? mqq.invokeClient("nav", "showProfile", a) : mqq.compare("4.6") >= 0 && !a.uinType ? mqq.invokeClient("nav", "showProfile", a) : (1 === a.uinType && (a.card_type = "group"),
        mqq.invokeSchema("mqqapi", "card", "show_pslcard", a));
    },
    android: function(a) {
        mqq.compare("4.7") >= 0 ? mqq.invokeClient("publicAccount", "showProfile", a) : mqq.compare("4.6") >= 0 && !a.uinType ? mqq.invokeClient("publicAccount", "showProfile", a.uin) : (1 === a.uinType && (a.card_type = "group"),
        mqq.invokeSchema("mqqapi", "card", "show_pslcard", a))
    },
    supportInvoke: !0,
    support: {
