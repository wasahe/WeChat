...
class backlist{
	...
	function getModuleFrames($name){
		global $_W;
		$frames = array();
		$frames['merchant_center']['title'] = '<i class="fa fa-inbox"></i>&nbsp;&nbsp; 商品';
		$frames['merchant_center']['items'] = array();
		$frames['merchant_center']['items']['merchant_center']['url'] = url('site/entry/merchant_center/',array('m'=>$name));
		$frames['merchant_center']['items']['merchant_center']['title'] = '商家中心';
		$frames['merchant_center']['items']['merchant_center']['actions'] = array();
		$frames['merchant_center']['items']['merchant_center']['active'] = '';
		...
		$frames['setting']['title'] = '<i class="fa fa-cog"></i>&nbsp;&nbsp; 核销';
		...
		$frames['setting']['items']['check']['url'] = url('site/entry/check/',array('m'=>$name));
		$frames['setting']['items']['check']['title'] = '核销订单';
		$frames['setting']['items']['check']['actions'] = array();
		$frames['setting']['items']['check']['active'] = '';
		
		$frames['setting']['title'] = '<i class="fa fa-cog"></i>&nbsp;&nbsp; 手工核销';
		$frames['setting']['items']['handhexiao']['url'] = url('site/entry/handhexiao/',array('m'=>$name));
		$frames['setting']['items']['handhexiao']['title'] = '手工核销';
		$frames['setting']['items']['handhexiao']['actions'] = array();
		$frames['setting']['items']['handhexiao']['active'] = '';
		return $frames;
