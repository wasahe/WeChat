...
public function fieldsFormDisplay($rid = 0) {
	...
	public function fieldsFormSubmit($rid) {
        ...
        $insert = array('rid' => $rid, 'weid' => $_W['uniacid'], 'uid' => $_W['uniacid'],'cover' => $_GPC['cover'], 'title' => $_GPC['title'], 'description' => $_GPC['description'], 'starttime' => strtotime($_GPC['starttime']), 'endtime' => strtotime($_GPC['endtime']), 'status' => intval($_GPC['status']), 'aid' => $_GPC['aid'], 'gift' => trim($_GPC['gift']), 'help' => trim($_GPC['help']));
        if (empty($id)){
