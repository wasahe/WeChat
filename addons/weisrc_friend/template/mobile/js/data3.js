	...
	var str = 
		'<li>' 
			...
			+			'<td valign="top" align="left">';
						...
						if( user.pics.length ){
                            str += '<div class="CommentImgArea2">';
                            if(link) {
                                str += '<a href="' + link + '">';
                            }
                            for ( key in user.pics ){
                                if (user.pics.length > 1) {
                                    str += '<img class="list-img" src="'+user.pics[key]+'">';
                                } else {
                                    str += '<img src="'+user.pics[key]+'">';
                                }
                            }
                            if(link) {
                                str += '</a>';
