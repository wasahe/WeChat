...
if(!pdo_fieldexists('str_store', 'email')) {
	pdo_query("ALTER TABLE ".tablename('str_store')." ADD `email` VARCHAR(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL;");
}
if(!pdo_fieldexists('str_store', 'secret')) {
	pdo_query("ALTER TABLE ".tablename('str_store')." ADD `secret` VARCHAR(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '打印机密钥';");
}
if(!pdo_fieldexists('str_store', 'code')) {
	pdo_query("ALTER TABLE ".tablename('str_store')." ADD  `code` VARCHAR(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '打印机编号';");
}
if(!pdo_fieldexists('str_print', 'print_type')) {
	pdo_query("ALTER TABLE ".tablename('str_print')." ADD  `print_type` INT(10) NOT NULL COMMENT '打印订单的类型';");
}