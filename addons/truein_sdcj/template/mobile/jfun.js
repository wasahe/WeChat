...
var effect = {
    ...
    mask : function(show) {
        ...
        if(!fbg){
            var html;
            html = '<div id="__frame__" style="display:none;position:absolute;top:0;left:0;background:#000;filter:alpha(opacity=60);-moz-opacity:0.6;-khtml-opacity: 0.6;opacity: 0.6;z-index:9999;border:none;width:100%;">';
