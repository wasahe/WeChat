...
if(!pdo_fieldexists('jy_tchd_attr',  'id')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_attr')." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists('jy_tchd_banner',  'id')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_banner')." ADD `id` int(11) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists('jy_tchd_code',  'id')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_code')." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists('jy_tchd_dianyuan',  'id')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_dianyuan')." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists('jy_tchd_jiedao',  'id')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_jiedao')." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists('jy_tchd_member',  'id')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_member')." ADD `id` int(11) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists('jy_tchd_member',  'thumb')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_member')." ADD `thumb` varchar(250) NOT NULL;");
}
...
if(!pdo_fieldexists('jy_tchd_mendian',  'id')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_mendian')." ADD `id` int(10) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists('jy_tchd_mendian',  'province')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_mendian')." ADD `province` varchar(200) DEFAULT NULL;");
}
if(!pdo_fieldexists('jy_tchd_mendian',  'city')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_mendian')." ADD `city` varchar(200) DEFAULT NULL;");
}
if(!pdo_fieldexists('jy_tchd_mendian',  'dist')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_mendian')." ADD `dist` varchar(200) DEFAULT NULL;");
}
...
if(!pdo_fieldexists('jy_tchd_setting',  'id')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_setting')." ADD `id` int(11) unsigned NOT NULL AUTO_INCREMENT;");
}
...
if(!pdo_fieldexists('jy_tchd_setting',  'sms_type')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_setting')." ADD `sms_type` int(10) NOT NULL DEFAULT '0' COMMENT '0,1为互亿无线,2为微擎';");
}
...
if(pdo_fieldexists('jy_tchd_url',  'enabled')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_url')." CHANGE `enabled` `enabled` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '0ForDeleted1ForExists';");
}
if(pdo_fieldexists('jy_tchd_hd',  'enabled')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_hd')." CHANGE `enabled` `enabled` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '是否删除';");
}
if(pdo_fieldexists('jy_tchd_attr',  'enabled')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_attr')." CHANGE `enabled` `enabled` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '是否开启';");
}
if(pdo_fieldexists('jy_tchd_banner',  'enabled')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_banner')." CHANGE `enabled` `enabled` tinyint(1) DEFAULT '0' COMMENT '0为纯图片,1为描述，2为链接跳转';");
}
if(pdo_fieldexists('jy_tchd_cate',  'enabled')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_cate')." CHANGE `enabled` `enabled` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '0ForDeleted1ForExists';");
}
if(pdo_fieldexists('jy_tchd_feedback',  'enabled')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_feedback')." CHANGE `enabled` `enabled` tinyint(1) DEFAULT '1';");
}
if(pdo_fieldexists('jy_tchd_jiedao',  'enabled')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_jiedao')." CHANGE `enabled` `enabled` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '是否删除';");
}
if(pdo_fieldexists('jy_tchd_menu',  'enabled')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_menu')." CHANGE `enabled` `enabled` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '0ForDeleted1ForExists';");
}
if(pdo_fieldexists('jy_tchd_synav',  'enabled')) {
	pdo_query("ALTER TABLE ".tablename('jy_tchd_synav')." CHANGE `enabled` `enabled` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '0ForDeleted1ForExists';");
}
?>