	...
	public function doWebOrderItemEdit()
	{
		...
		if (checksubmit('submit')) {
			$data = array(
				...
				'xj_price_name' => $_GPC['xj_price_name'],
...
//		}
   ...
   public function doMobilePaySuccess() {
	...
	public function findOrder($iid,$openid) {
		return pdo_fetch("select * from ".tablename(DBUtil::$TABLE_ORDER_ORDER)." where openid=:openid and iid=:iid and status <> 4",
			array(":openid"=>$openid, ":iid"=>$iid));
