...
function getapplicationFrames(){
	...
	if($_GPC['ac'] == 'plugins'){
		...
		if(!TG_ID){
		$frames['merchant']['items']['merchantlist']['url'] = web_url('application/merchant/account_display',array('status' => '1'));
		$frames['merchant']['items']['merchantlist']['title'] = '多商户';
		$frames['merchant']['items']['merchantlist']['actions'] = array('op','account_display');
		...
		$frames['task']['title'] = '<i class="fa fa-cloud"></i>&nbsp;&nbsp; 常用工具';
		$frames['task']['items'] = array();
	
		$frames['task']['items']['task']['url'] = web_url('application/task/display');
		$frames['task']['items']['task']['title'] = '计划任务';
		$frames['task']['items']['task']['actions'] = array();
		$frames['task']['items']['task']['active'] = '';
		}else{
	...
	if($_GPC['ac'] == 'task'){
		$frames['task']['title'] = '<i class="fa fa-cloud"></i>&nbsp;&nbsp; 计划任务';
		$frames['task']['items'] = array();
	
		$frames['task']['items']['task']['url'] = web_url('application/task/display');
		$frames['task']['items']['task']['title'] = '任务授权';
		$frames['task']['items']['task']['actions'] = array();
		$frames['task']['items']['task']['active'] = '';
		
		$frames['task']['items']['edit']['url'] = web_url('application/task/list');
		$frames['task']['items']['edit']['title'] = '任务列表';
		$frames['task']['items']['edit']['actions'] = array();
		$frames['task']['items']['edit']['active'] = '';
	}
...
function getsystemFrames(){
	...
	$frames['member']['items']['setting']['actions'] = array();
	$frames['member']['items']['setting']['active'] = '';
	$frames['member']['items']['setting']['append']['url'] = web_url('system/auth/display');
