...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_adpc` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_cashier_order` (
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_cashier_store` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_cashier_store_waiter` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_cashier_withdraw` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='收银台商户提现表' AUTO_INCREMENT=8 ;
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_category2` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0' COMMENT '所属帐号',
  `name` varchar(50) DEFAULT NULL COMMENT '分类名称',
  `thumb` varchar(255) DEFAULT NULL COMMENT '分类图片',
...
(17, 17, 'yunpay', '云支付', '1.0', '云支付', 1, 'tool'),
(18, 18, 'diyform', '自定义表单', '1.0', '官方', 1, 'help'),
(19, 19, 'system', '系统工具', '1.0', '官方', 1, 'help'),
(20, 20, 'ranking', '排行榜', '1.0', '官方', 1, 'help'),
(21, 21, 'choose', '快速选购', '1.0', '官方', 1, 'tool'),
(22, 22, 'bonus', '芸众分红', '1.0', '官方', '1','biz'),
(23, 23, 'cashier', '收银台', '1.0', '官方', '1','biz');
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_ranking` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `mid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_refund_address` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_return_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `mid` int(11) NOT NULL,
  `openid` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_sz_yi_system_copyright` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT NULL,
  `copyright` text,
  `bgcolor` varchar(255) DEFAULT '',
