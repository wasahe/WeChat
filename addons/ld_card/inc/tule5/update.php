<?php
pdo_query("CREATE TABLE IF NOT EXISTS `ims_ld_card_cards` (
...
if(pdo_tableexists('ld_card_users')) {
	if(!pdo_fieldexists('ld_card_users',  'lng')) {
		pdo_query("ALTER TABLE ".tablename('ld_card_users')." ADD `lng` varchar(255);");
	}	
}
if(pdo_tableexists('ld_card_users')) {
	if(!pdo_fieldexists('ld_card_users',  'lat')) {
		pdo_query("ALTER TABLE ".tablename('ld_card_users')." ADD `lat` varchar(255);");
	}	
}
if(pdo_tableexists('ld_card_users')) {
	if(!pdo_fieldexists('ld_card_users',  'yyzz')) {
		pdo_query("ALTER TABLE ".tablename('ld_card_users')." ADD `yyzz` varchar(255);");
	}	
}
if(pdo_tableexists('ld_card_users')) {
	if(!pdo_fieldexists('ld_card_users',  'status')) {
		pdo_query("ALTER TABLE ".tablename('ld_card_users')." ADD `status` tinyint(4) DEFAULT '1';");
	}	
}
