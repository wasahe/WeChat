...
$(function() {
	...
	$.fn.facebox = function(options) {
	    ...
	    for(i=0;i<60;i++){   //通过循环创建60个表情，可扩展
		 faceimg+='<li><a href="javascript:void(0)"><img src="../addons/bsht_tbk/plus/dan/mobile/js/Share/face/'+(i+1)+'.gif" face="'+getemtname(i+1)+'"/></a></li>';
		 };
  ...
  //  光标定位插件
	...
	$.fn.extend({
		replaceface : function(faces){
			...
			var s = '<img class="faceimg" src="../addons/bsht_tbk/plus/dan/mobile/js/Share/face/';
			var e = '.gif">';
