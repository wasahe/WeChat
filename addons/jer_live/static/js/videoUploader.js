    ...
    fileUploader = {
        ...
        'init_video' : function() {
            ...
            this.modalobj.find('#video').find('button.btn-primary').on('click', function(){
                ...
                $('#fileUploader_video_form').attr('action', url);
        ...
        'localPage' : function(page) {
            ...
            var acid = $this.acid;
            var type = $this.type;
            $.getJSON('./index.php?c=utility&a=wechat_file&do=browser', {'page': page, 'acid' : acid, 'type' : type}, function(data){
                data = data.message;
        ...
        'init_upload' : function(){
            ...
            if(this.modalobj.find('#wechat_upload').length == 0){
                ...
                this.modalobj.find('.nav-pills').append('<li role="presentation" data-mode="perm"><a aria-controls="upload" role="tab" data-toggle="tab" href="#wechat_upload" >上传文件</a></li>');
            ...
            if(this.modalobj.find('#wechat_upload').length == 0){
                ...
                function updateStatus() {
                    ...
                    if (state === 'ready') {
                        var acid = $this.acid;
                        if(!$this.flag) {
                            uploader.option('server', uploader.option('server') + 'acid=' + acid + '&types=' + $this.type);
                            $this.flag = 1;
                        }
