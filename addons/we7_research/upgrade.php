...
if(!pdo_fieldexists('research', 'is_sms')) {
	pdo_query("ALTER TABLE ".tablename('research')." ADD  `is_sms` int(10) NOT NULL DEFAULT '0' COMMENT '是否开启短信';");
}
if(!pdo_fieldexists('research', 'sms_id')) {
	pdo_query("ALTER TABLE ".tablename('research')." ADD   `sms_id` varchar(20) NOT NULL COMMENT '短信模板ID';");
}