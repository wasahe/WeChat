...
function praise(){
		...
		$.ajax({
			type:'POST',
			url:'./index.php?i='+i+'&j='+j+'&c=entry&do=praise&m=meepo_online',
...
function send_message(){
			...
			var i = _meepoajax._querystring('i');
			var j = _meepoajax._querystring('j');
			var post_url = './index.php?i='+i+'&j='+j+'&c=entry&do=comment_reply&m=meepo_online';
...
function AutoLoad(){
	...
	var i = _meepoajax._querystring('i');
	var j = _meepoajax._querystring('j');
	var post_url = './index.php?i='+i+'&j='+j+'&c=entry&do=get_comment_newjoin&m=meepo_online';
	$.ajax({
		type:'get',
		url:post_url,
...
function loadMore(){
	...
	var i = _meepoajax._querystring('i');
	var j = _meepoajax._querystring('j');
	var post_url = './index.php?i='+i+'&j='+j+'&c=entry&do=get_comment_reply&m=meepo_online';
	$.ajax({
		type:'get',
		url:post_url,
...
function AutoLoad2(){
	...
	var i = _meepoajax._querystring('i');
	var j = _meepoajax._querystring('j');
	var post_url = './index.php?i='+i+'&j='+j+'&c=entry&do=get_news_new&m=meepo_online';
	$.ajax({
		type:'get',
		url:post_url,
		data:{'type':'new_join','listid':$("#live_id").val(),'max':pageReset},
...
function loadMore2(){
	...
	var i = _meepoajax._querystring('i');
	var j = _meepoajax._querystring('j');
	var post_url = './index.php?i='+i+'&j='+j+'&c=entry&do=get_comment_news&m=meepo_online';
	$.ajax({
		type:'get',
		url:post_url,
		data:{'type':'comment','listid':$("#live_id").val(),'page':page,'update_time':$('#page_time').val()},
...
//SOCKET.emit('dashang',{'type':'redpack','gift_number':1,'money':'111','openid':$('#wx_openid').val()});
	...
	if(clickTime && alsoTime < 60000){
		...
		if(liveID.attr("ctime")){
			var i = _meepoajax._querystring('i');
			var j = _meepoajax._querystring('j');
			var post_url = './index.php?i='+i+'&j='+j+'&c=entry&do=wechatpay&m=meepo_online';
			$.ajax({
				type:'post',
...
function shakeEventDidOccur(){
	...
	if(shake.is(':hidden')==false && shake.attr('data-shake')=='on'){
		...
		setTimeout(function(){
			var i = _meepoajax._querystring('i');
			var j = _meepoajax._querystring('j');
			var post_url = './index.php?i='+i+'&j='+j+'&c=entry&do=shake&m=meepo_online';
			$.ajax({
				type:'post',
...
function send_rm(){
	...
	var i = _meepoajax._querystring('i');
	var j = _meepoajax._querystring('j');
	var post_url = './index.php?i='+i+'&j='+j+'&c=entry&do=update_fans&m=meepo_online';
	$.ajax({
	type : "POST",
	url : post_url,
	data : submitData,
...
function pay_look(){
	var i = _meepoajax._querystring('i');
	var j = _meepoajax._querystring('j');
	var post_url = './index.php?i='+i+'&j='+j+'&c=entry&do=look_pay&m=meepo_online';
	$.ajax({
		type : "POST",
		url : post_url,
