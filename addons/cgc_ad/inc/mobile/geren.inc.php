...
if ($op == 'tx') {
    ...
    //$list=pdo_fetchall("SELECT a.*,a.nickname,a.headimgurl FROM ".tablename('cgc_ad_member')." a WHERE a.weid=".$weid." AND a.quan_id=".$quan_id." AND status=1 AND a.inviter_id=".$mid." ORDER BY a.up_money DESC,id ASC LIMIT 30 ");
