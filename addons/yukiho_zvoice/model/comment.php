...
class comment
{
    public $table = 'yukiho_zvoice_comment';
    ...
    public function getMycomments($page,$openid){
        global $_W;
    ...
    public function getTotal($speech_id){
        global $_W;
        $sql = "SELECT COUNT(*) FROM ".tablename($this->table)." WHERE speech_id = :speech_id AND uniacid = :uniacid ";
        $params = array(':speech_id'=>$speech_id,':uniacid'=>$_W['uniacid']);
