...
class online_log
{
    public $table = 'yukiho_zvoice_online_log';
    ...
    public function install(){
        ...
        if(!pdo_fieldexists($this->table,'online_id')){
            pdo_query("ALTER TABLE ".tablename($this->table)." ADD COLUMN `online_id` int(11) DEFAULT '0'");
        }
    }
}