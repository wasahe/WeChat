(function(jQuery){
	...
	$.fn.BreakingNews = function(settings){
			...
			return this.each(function(){
				...
				$(settings.modulid+' .bn-title').css({'background':settings.titlebgcolor,'color':settings.titlecolor});
				$(settings.modulid+' ul li a').css({'font-weight':fontw,'height':parseInt(settings.fonttextsize)+6});
