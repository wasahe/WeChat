...
$obj = new Siyuan_Vod_doMobileDay();
$obj->exec();
class Siyuan_Vod_doMobileDay extends Siyuan_VodModuleSite
{
	...
	public function exec()
	{
		...
		$title = $set['name'];
		$list = pdo_fetchall('SELECT id,time,title,thumb,shuxing,lianzai,blei,slei FROM ' . tablename('siyuan_vod') . 'WHERE weid = ' . $_W['uniacid'] . ' ORDER BY time DESC LIMIT 30');
