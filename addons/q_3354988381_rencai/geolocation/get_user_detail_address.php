<?php if (!$weixin_get_fans_location || $_SESSION['weixin_get_fans_location'] == '未知'){?>    
	<script type="text/javascript" src="../addons/q_3354988381_rencai/ui/jq/jquery-2.2.3.js"></script>
