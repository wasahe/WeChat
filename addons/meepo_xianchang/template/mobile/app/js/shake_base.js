...
if (!Array.prototype.indexOf) {
    ...
    b.showPage = function(c) {
        var d = b('<div class="frame-dialog"><div class="phbphb" id="phbphb"><img src="'+WEB_URL+'images/phbphb.png" class="phbtop" ><div class="phbk"><div class="phbbiaok"><iframe frameborder="0" src="' + c + '"></iframe></div></div></div><div class="closebutton"></div></div>');
