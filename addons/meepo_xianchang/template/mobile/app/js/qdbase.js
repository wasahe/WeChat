...
if (!Array.prototype.indexOf) {
	...
	b.showPage = function(c) {
		...
		d.appendTo("body").show().on("click", ".closebutton", function() {
			d.hide(function() {
				d.remove();
				d = null
			})
	...
	a.WBActivity = {
		...
		hideLoginForm: function() {
			...
			setTimeout("senddh("+0+")",1000);//hide login do
		},
	...
	b(function() {
		...
		if (!d) {
			...
			a.WBActivity.start();
			document.getElementById("ddd").style.display='block';//签到墙体show
			setTimeout("senddh("+0+")",1000);
		}
	});
