	...
	;(function(g, r, h, t, v) {
	    ...
	    var q = function(a, b, c) {
	        ...
	        if (c = c.prop("value"))
	            ...
	            c[0] && c[0] == +c[0] && (c[0] = +c[0]),
	            c[1] && c[1] == +c[1] && (c[1] = +c[1]),
	            b && b.values && b.values.length ? (a.from = c[0] && b.values.indexOf(c[0]),
	            a.to = c[1] && b.values.indexOf(c[1])) : (a.from = c[0] && +c[0],
	            a.to = c[1] && +c[1]);
	        b = g.extend(a, b);
	    ...
	    q.prototype = {
	        init: function(a) {
	            ...
	            this.setMinMax();
	            if (a) {
	                if (this.force_redraw = !0,
	                this.calc(!0),
	                this.options.onUpdate && "function" === typeof this.options.onUpdate)
	                    this.options.onUpdate(this.result)
	            } else if (this.force_redraw = !0,
	            this.calc(!0),
	            this.options.onStart && "function" === typeof this.options.onStart)
	        ...
	        remove: function() {
	            ...
	            p && (this.$cache.body.off("mouseup.irs_" + this.plugin_count),
	        ...
	        bindEvents: function() {
	            ...
	            this.$cache.shad_from.on("touchstart.irs_" + this.plugin_count, this.pointerClick.bind(this, 
	            "click")),
	            ...
	            if (this.options.keyboard)
	                this.$cache.line.on("keydown.irs_" + 
	                this.plugin_count, this.key.bind(this, "keyboard"));
	            p && (this.$cache.body.on("mouseup.irs_" + this.plugin_count, this.pointerUp.bind(this)),
	        ...
	        calcLabels: function() {
	            ...
	            this.labels.p_single_left = this.coords.p_single + this.coords.p_handle / 2 - this.labels.p_single / 2) : (this.labels.w_from = this.$cache.from.outerWidth(!1),
	            ...
	            this.labels.p_single_left = (this.labels.p_from_left + this.labels.p_to_left + this.labels.p_to) / 2 - this.labels.p_single / 
	            2,
	                ...
	                if (this.coords.w_rs && (this.dragging || this.force_redraw || this.is_key)) {
	                    ...
	                    this.result.to || this.force_redraw || this.is_key) {
	                        ...
	                        if ("single" === this.options.type)
	                            ...
	                            this.result.from_value + ";" + this.result.to_value),
	                        ...
	                        "function" === typeof this.options.onChange && !this.is_resize && !this.is_update && !this.is_start)
	                            this.options.onChange(this.result);
	                        if (this.options.onFinish && "function" === typeof this.options.onFinish && (this.is_key || this.is_click))
	                            this.options.onFinish(this.result);
	            ...
	            if (this.options) {
	                ...
	                if (!this.options.hide_from_to)
	                    if ("single" === this.options.type)
	                        ...
	                        b = this.decorate(b[this.result.to])) : (this.options.decorate_both ? (a = this.decorate(this._prettify(this.result.from), this.result.from),
	                        a += this.options.values_separator,
	                        ...
	                        c = this.decorate(this._prettify(this.result.from), 
	                        this.result.from),
	                        ...
	                        this.$cache.single[0].style.visibility = "visible",
	                        d = Math.max(a, c))) : (this.$cache.from[0].style.visibility = "visible",
	        ...
	        drawShadow: function() {
	            ...
	            d = this.calcPercent(a.from_max || a.max) - c,
	            c = this.toFixed(c - this.coords.p_handle / 
	            100 * c),
	            d = this.toFixed(d - this.coords.p_handle / 100 * d),
	            c += this.coords.p_handle / 2,
	            b.shad_single[0].style.display = "block",
	            b.shad_single[0].style.left = c + "%",
	            ...
	            b.shad_from[0].style.left = 
	            c + "%",
	            b.shad_from[0].style.width = d + "%") : b.shad_from[0].style.display = "none",
	            a.to_shadow && (e || f) ? (e = this.calcPercent(a.to_min || a.min),
	            a = this.calcPercent(a.to_max || a.max) - e,
	        ...
	        calcReal: function(a) {
	            var b = this.options.min, c = this.options.max, d = b.toString().split(".")[1], e = c.toString().split(".")[1], f, k, l = 0, g = 0;
	            d && (l = f = d.length);
	            e && (l = k = e.length);
	            f && k && (l = f >= k ? f : k);
	            0 > b && (g = Math.abs(b),
	            ...
	            c = +(c + g).toFixed(l));
	            a = (c - b) / 100 * a + b;
	            (d = this.options.step.toString().split(".")[1]) ? a = a !== b && a !== c ? +a.toFixed(d.length) : +a.toFixed(l) : (a /= this.options.step,
	            a *= this.options.step,
	            a = +a.toFixed(0));
	            g && (a -= g,
	            b = this.options.min,
	        ...
	        validate: function() {
	            ...
	            a.max <= a.min && (a.max = a.min ? 2 * a.min : a.min + 1,
	            a.step = 1);
	            if (d)
	                for (a.p_values = [],
	                a.min = 0,
	            ...
	            if ("number" !== typeof a.from || isNaN(a.from))
	                a.from = a.min;
	            if ("number" !== typeof a.to || isNaN(a.from))
	                a.to = a.max;
	            if ("single" === a.type)
	            ...
	            if ("number" !== typeof a.step || isNaN(a.step) || !a.step || 0 > a.step)
	                a.step = 1;
	            if ("number" !== typeof a.keyboard_step || isNaN(a.keyboard_step) || !a.keyboard_step || 0 > a.keyboard_step)
	                a.keyboard_step = 5;
	        ...
	        decorate: function(a, b) {
	            ...
	            c += a;
	            d.max_postfix && 
	            (d.values.length && a === d.p_values[d.max] ? (c += d.max_postfix,
	        ...
	        appendGrid: function() {
	            if (this.options.grid) {
	                ...
	                b = a.max - a.min;
	                var d = a.grid_num, e = 0, f = 0, k = 4, g, h, m = 0, n = "";
	                this.calcGridMargin();
	                a.grid_snap ? (d = b / a.step,
	                e = this.toFixed(a.step / (b / 100))) : e = this.toFixed(100 / d);
	                4 < d && (k = 3);
	                7 < d && (k = 2);
	                14 < d && (k = 1);
	                28 < d && (k = 0);
	        ...
	        calcGridLabels: function() {
	            ...
	            c[0] = this.toFixed(b[0] + this.coords.big_p[0]),
	            this.coords.big_x[0] = this.coords.grid_gap),
	            c[d - 1] > 100 + this.coords.grid_gap && (c[d - 1] = 100 + this.coords.grid_gap,
	            b[d - 1] = this.toFixed(c[d - 1] - this.coords.big_p[d - 1]),
	        ...
	        calcGridMargin: function() {
	            ...
	            this.coords.p_handle = this.toFixed(this.coords.w_handle / 
	            this.coords.w_rs * 100),
	            this.coords.grid_gap = this.toFixed(this.coords.p_handle / 2 - .1),
	            this.$cache.grid[0].style.width = this.toFixed(100 - this.coords.p_handle) + "%",
	            this.$cache.grid[0].style.left = this.coords.grid_gap - 1 + "%"))
	        },
	        update: function(a) {
	    ...
	    ;
	    (function() {
	        for (var a = 0, b = ["ms", "moz", "webkit", "o"], c = 0; c < b.length && !h.requestAnimationFrame; ++c)
	            h.requestAnimationFrame = h[b[c] + "RequestAnimationFrame"],
