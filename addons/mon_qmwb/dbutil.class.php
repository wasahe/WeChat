...
class DBUtil
{
    ...
    public static $TABLE_QMWB = "mon_qmwb";
    public static $TABLE_QMWB_ADDRESS = "mon_qmwb_address";
    public static $TABLE_QMWB_PRIZE = "mon_qmwb_prize";
    public static $TABLE_QMWB_USER = "mon_qmwb_user";
    public static $TABLE_QMWB_RECORD = "mon_qmwb_record";
    public static $TABLE_QMWB_FIREND = "mon_qmwb_firend";
    public static $TABLE_QMWB_SETTING = "mon_qmwb_setting";
