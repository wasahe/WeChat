...
class Index_EweiShopV2Page extends MobileLoginPage
{
	...
	public function getsignature()
	{
		...
		$openid = $_GPC['openid'];
		$signature = com('wxcard')->getsignature($card_id, $timestamp, $nonce_str, $openid);
		show_json(1, array('timestamp' => $timestamp, 'nonce_str' => $nonce_str, 'signature' => $signature));
	}
	...
	public function updateQuantity()
	{
		...
		foreach ($cardList as $card) {
			pdo_insert('debug', array('message' => $card['cardId']));
