    ...
    modal.getNavs = function () {
        modal.navs = {
            notice: {
                name: '公告',
                params: {
                    'iconurl': '../addons/ewei_shopv2/plugin/diypage/static/images/default/hotdot.jpg',
                    'noticedata': '0',
                    'speed': '4',
                    'noticenum': '5'
                },
            ...
            pictures: {
                ...
                data: {
                    C0123456789101: {
                        imgurl: '../addons/ewei_shopv2/plugin/diypage/static/images/default/movie-poster.jpg',
                        linkurl: '',
                        title: '这里是上标题',
                        text: '这里是下标题'
                    },
            ...
            member: {
                ...
                style: {'background': '#fe5455', 'textcolor': '#ffffff', 'textlight': '#fef31f', 'headstyle': ''},
            ...
            icongroup: {
                ...
                data: {
                    C0123456789101: {iconclass: 'icon-card', text: '待付款', linkurl: '', dotnum: 0},
                    C0123456789102: {iconclass: 'icon-box', text: '待发货', linkurl: '', dotnum: 0},
                    C0123456789103: {iconclass: 'icon-deliver', text: '待收货', linkurl: '', dotnum: 0},
                    C0123456789104: {iconclass: 'icon-electrical', text: '退换货', linkurl: '', dotnum: 0}
                }
            },
            bindmobile: {
                name: '绑定手机',
            ...
            logout: {
                ...
                style: {textcolor: '#ff0011', background: '#ffffff', margintop: '10'}
            },
            memberc: {
                name: '会员信息',
                type: 4,
                ...
                style: {background: '#fe5455', textcolor: '#ffffff', textlight: '#fef31f'}
            },
            blockgroup: {
                name: '图标块',
                params: {rownum: 3},
            ...
            detail_package: {
                ...
                max: 1,
                params: {},
                style: {background: "#ffffff", margintop: 10, marginbottom: 0, textcolor: "#7c7c7c"}
            },
            detail_pullup: {
                name: "上拉详情",
                type: 5,
            ...
            seckillgroup: {
                ...
                name: "秒杀组",
                params: {
                    iconurl: '../addons/ewei_shopv2/plugin/diypage/static/images/default/seckill.jpg',
                    hideborder: 0,
                    tag: ''
                },
                style: {
