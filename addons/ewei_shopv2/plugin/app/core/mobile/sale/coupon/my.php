...
class My_EweiShopV2Page extends AppMobilePage
{
	...
	public function getdetail()
	{
		...
		$detail = array('name' => $coupon['couponname'], 'merchstr' => $coupon['merchname'] ? '限购' . $coupon['merchname'] . '店铺商品' : '', 'title2' => $coupon['title2'], 'title3' => $coupon['title3'], 'color' => $coupon['color'], 'islimitlevel' => $coupon['islimitlevel'], 'gettypestr' => $coupon['gettypestr'], 'coupontype' => $coupon['coupontype'], 'limitdiscounttype' => $coupon['limitdiscounttype'], 'limitgoodtype' => $coupon['limitgoodtype'], 'limitgoodcatetype' => $coupon['limitgoodcatetype'], 'limitgoods' => $goods, 'limitcates' => $category, 'num' => $num);
