<?php
set_time_limit(0);
pdo_query("CREATE TABLE `ims_ewei_message_mass_sign` (
...
CREATE TABLE `ims_ewei_shop_lottery` (
  ...
  `lottery_type` tinyint(1) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_wxcard` (
  ...
  `begin_timestamp` int(11) DEFAULT '0',
  `end_timestamp` int(11) DEFAULT '0',
  `fixed_term` int(11) DEFAULT '0',
  `fixed_begin_term` int(11) DEFAULT '0',
  `quantity` int(11) DEFAULT '0',
  `total_quantity` varchar(255) DEFAULT NULL,
  `use_limit` int(11) DEFAULT '0',
  `get_limit` int(11) DEFAULT '0',
  `use_custom_code` tinyint(1) DEFAULT '0',
  `bind_openid` tinyint(1) DEFAULT '0',
  ...
  `can_use_with_other_discount` tinyint(1) DEFAULT '0',
  `setabstract` tinyint(1) DEFAULT '0',
  ...
  `least_cost` decimal(10,2) DEFAULT '0.00',
  `reduce_cost` decimal(10,2) DEFAULT '0.00',
  `discount` decimal(10,2) DEFAULT '0.00',
  `limitgoodtype` tinyint(1) DEFAULT '0',
  `limitgoodcatetype` tinyint(1) DEFAULT '0',
...
(37, 40, 'lottery','游戏营销','1.0','官方',1,'help',1,'../addons/ewei_shopv2/static/images/lottery.jpg','',0,0);
");