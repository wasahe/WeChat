<?php
require_once GARCIA_PATH."class/wechatDemo/lib/WxPay.Exception.php";
require_once GARCIA_PATH."class/wechatDemo/lib/WxPay.Config.php";
require_once GARCIA_PATH."class/wechatDemo/lib/WxPay.Data.php";
...
class WxPayApi
{
	 ...
	 * @return 成功时返回，其他抛异常
	 */
	public static function orderQuery($inputObj, $APPID,$MCHID,$key,$timeOut = 6)
	{
