 ...
 */
  ...
  // include GARCIA_TOOLS.'memcache.class.php';
  class Common extends WeModuleSite{
         ...
         public  function  Init(){
             ...
             // echo GARCIA_TOOLS.'memcache.class.php'
             //检测微信状态
         ...
         */
          ...
          */
          public function _wallet($openid){
              ...
              return $wallket=$wallket['credit2'];
          }
   ...
   */
    ...
    /**
        ...
        public function _SetQRcode($token){
            global $_W;
            include GARCIA_TOOLS."phpqrcode.php";

            $value = $_W['siteroot'].'/'.$this->createMobileUrl('weixin_login',array('token'=>$token)); //二维码内容
            $errorCorrectionLevel = 'L';//容错级别
            $matrixPointSize = 6;//生成图片大小
            $_res_img =  ATTACHMENT_ROOT.'/qrcode_qsc_'.$this->weid.'.png';
            $_res_img_url = "../attachment/qrcode_qsc_".$this->weid.".png";
            //生成二维码图片
