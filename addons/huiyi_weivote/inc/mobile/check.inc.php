...
function Mobile_CheckAjax($isajax)
{
    ...
    if (!$isajax) {
        ...
        $rd->setMsg('呵呵，访问出错了哦，请联系作者Man.Dan QQ:82089092');
        return $rd;
    }
    $servername = $_SERVER['SERVER_NAME'];
    $httpreferer = $_SERVER['HTTP_REFERER'];
    //if (!(strpos($httpreferer, 'http://demo.012wz.com/') === 0)) {
    //    $rd->setCode(201);
    //    $rd->setNode('Mobile_CheckAjax');
     //   $rd->setMsg('呵呵，访问出错了哦，请联系作者Man.Dan QQ:82089092');
     //   return $rd;
...
function Mobile_CheckServer($theThis, $uniacid)
{
    ...
    $rd = new ReturnData('');
    $servername = $_SERVER['SERVER_NAME'];
    if (strpos($servername, 'demo.012wz.com') !== false) {
    }// else {
      //  $rd->setCode(200);
      //  $rd->setNode('Mobile_CheckServer');
      //  $rd->setMsg($servername . ' 您的域名未获得授权，请联系《微信投票》作者:Man.Dan QQ:82089092 ');
    //}
    return $rd;
}
