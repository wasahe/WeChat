...
KISSY.use('node,io', function(S, Node, IO) {
	...
	loadImages(['../source/modules/hc_deluxejjr/style/images/bg-loader.jpg', '../source/modules/hc_deluxejjr/style/images/ico-logo.png', '../source/modules/hc_deluxejjr/style/images/sales-bg-loader.jpg', '../source/modules/hc_deluxejjr/style/images/ico-sales-logo.png'], function() {
		setTimeout(function() {
	...
	//经纪人注册
	var submit_hc_deluxejjrr = $('#J_submitReg');
	...
	submit_hc_deluxejjrr.on('click', function() {
		//姓名
		if (name.length == 1) {
		...
		//请求
		IO.post('/source/modules/hc_deluxejjr/mobile/register.php', DATA, function(data) {
			if (data.status == 200) {
				IO.post('/Home/hc_deluxejjrr/register', DATA, function(data) {
					if (data.status == 200) {
						alert("注册成功");

						var return_url = $('#return_url').val();
						if (return_url == '') {
							location.href = '/Home/hc_deluxejjrr/center';
						} else {
    ...
    complete.on('click',function(){
        ...
        IO.post('/Home/hc_deluxejjrr/complete', DATA, function(data) {
            if (data.status == 200) {
                alert("保存成功");
                location.href = '/Home/hc_deluxejjrr/center';
            } else {
