...
function() {
    ...
    function(e, t, n) { (function(t) { !
            function(n) {
                ...
                function u() {
                    for (var e = 0,
                    t = this._deferreds.length; t > e; e++) o.call(this, this._deferreds[e]);
    ...
    function(e, t) {
        ...
        function r() {
            ...
            this.append = function(e, r, i) {
                ...
                r instanceof Blob ? (t.push('; filename="' + (i || "blob") + '"\r\nContent-Type: ' + r.type + "\r\n\r\n"), t.push(r)) : t.push("\r\n\r\n" + r),
                t.push("\r\n")
            },
    ...
    function(e, t, n) {
        var r, i; (function() {
            ...
            function a(e, t) {
                ...
                n.open("GET", e, !0),
                n.responseType = "blob",
                n.onload = function(e) { (200 == this.status || 0 === this.status) && t(this.response)
                },
                n.send()
            }
            function s(e, t) {
            ...
            function u(e) {
                ...
                if (p && console.log("Got file of length " + e.byteLength), 255 != t.getUint8(0) || 216 != t.getUint8(1)) return p && console.log("Not a valid JPEG"),
                !1;
                for (var n, r = 2,
                i = e.byteLength; i > r;) {
                    if (255 != t.getUint8(r)) return p && console.log("Not a valid marker at offset " + r + ", found: " + t.getUint8(r)),
                    !1;
                    if (n = t.getUint8(r + 1), p && console.log(n), 225 == n) return p && console.log("Found 0xFFE1 marker"),
            ...
            function l(e, t, n) {
                for (var r, i, o, a, s, u = new DataView(e), c = {},
                l = t; t + n > l;) 28 === u.getUint8(l) && 2 === u.getUint8(l + 1) && (a = u.getUint8(l + 2), a in S && (o = u.getInt16(l + 3), s = o + 5, i = S[a], r = h(u, l + 5, o), c.hasOwnProperty(i) ? c[i] instanceof Array ? c[i].push(r) : c[i] = [c[i], r] : c[i] = r)),
                l++;
                return c
            }
            ...
            function d(e, t, n, r, i) {
                ...
                case 4:
                    ...
                    return a;
                case 5:
                    if (1 == d) return c = e.getUint32(g, !i),
                    l = e.getUint32(g + 4, !i),
                    s = new Number(c / l),
                    s.numerator = c,
                    s.denominator = l,
                    s;
                    for (a = [], u = 0; d > u; u++) c = e.getUint32(g + 8 * u, !i),
            ...
            function g(e, t) {
                if ("Exif" != h(e, t, 4)) return p && console.log("Not valid EXIF data! " + h(e, t, 4)),
                !1;
                var n, r, i, o, a, s = t + 6;
                if (18761 == e.getUint16(s)) n = !1;
                else {
                    if (19789 != e.getUint16(s)) return p && console.log("Not valid TIFF data! (no 0x4949 or 0x4D4D)"),
                    !1;
                    n = !0
                }
                if (42 != e.getUint16(s + 2, !n)) return p && console.log("Not valid TIFF data! (no 0x002A)"),
                !1;
                var u = e.getUint32(s + 4, !n);
                if (8 > u) return p && console.log("Not valid TIFF data! (First offset less than 8)", e.getUint32(s + 4, !n)),
                !1;
    ...
    function(e, t, n) {
        ...
        function() {
            ...
            c.prototype.render = function(e, t, n) {
                ...
                f && !d ? d = l * f / c << 0 : d && !f ? f = c * d / l << 0 : (f = c, d = l),
                h && f > h && (f = h, d = l * f / c << 0),
                g && d > g && (d = g, f = c * d / l << 0);
                var m = {
                    width: f,
    ...
    function(e, t) {
        function n(e) {
            function t(e) {
                ...
                for (var s = [1, 1.387039845, 1.306562965, 1.175875602, 1, .785694958, .5411961, .275899379], u = 0, c = 0; 8 > c; c++) for (var l = 0; 8 > l; l++) U[u] = 1 / (x[N[u]] * s[c] * s[l] * 8),
                C[u] = 1 / (D[N[u]] * s[c] * s[l] * 8),
                u++
            }
            function n(e, t) {
                for (var n = 0,
            ...
            function i() {
                ...
                t = 2,
                n = 1; 15 >= n; n++) {
                    for (var r = e; t > r; r++) A[32767 + r] = n,
                    T[32767 + r] = [],
                    T[32767 + r][1] = n,
                    T[32767 + r][0] = r;
                    for (var i = -(t - 1); - e >= i; i++) A[32767 + i] = n,
                    T[32767 + i] = [],
                    T[32767 + i][1] = n,
                    T[32767 + i][0] = t - 1 + i;
                    e <<= 1,
            ...
            function o() {
                for (var e = 0; 256 > e; e++) k[e] = 19595 * e,
                k[e + 256 >> 0] = 38470 * e,
            ...
            function a(e) {
                for (var t = e[0], n = e[1] - 1; n >= 0;) t & 1 << n && (G |= 1 << O),
                n--,
                O--,
                0 > O && (255 == G ? (s(255), s(0)) : s(G), O = 7, G = 0)
            }
            function s(e) {
                M.push(j[e])
            }
            ...
            function p(e, t, n, r, i) {
                ...
                var p = R[0] - n;
                n = R[0],
                0 == p ? a(r[0]) : (o = 32767 + p, a(r[A[o]]), a(T[o]));
            ...
            this.encode = function(e, t, n) {
                ...
                for (var c, m, v, P, F, x, D, T, A, L = e.data,
                R = e.width,
                j = e.height,
                N = 4 * R,
                W = 0; j > W;) {
                    for (c = 0; N > c;) {
                        for (F = N * W + c, x = F, D = -1, T = 0, A = 0; 64 > A; A++) T = A >> 3,
                        D = 4 * (7 & A),
                        x = F + T * N + D,
                        W + T >= j && (x -= N * (W + 1 + T - j)),
                        c + D >= N && (x -= c + D - N + 4),
                ...
                if (u(65497), n) {
                    for (var z = M.length,
                    q = new Uint8Array(z), V = 0; z > V; V++) q[V] = M[V].charCodeAt();
                    M = []; (new Date).getTime() - r;
                    return q
                }
    ...
    function(e, t, n) {
        ...
        function i(e) {
            var t = null;
            return t = e ? [].filter.call(document.scripts,
            function(t) {
            ...
            return new a(function(n, a) {
                ...
                i.onload = function() {
                    e._getBase64().then(function(e) {
                        return e.length < 10 && a("生成base64失败"),
                        e
                    }).then(function(r) {
                        var i = null;
                        "object" == typeof e.file && r.length > e.file.size ? (i = new FormData, t = e.file) : (i = new s.FormData, t = o(r)),
        ...
        r.prototype._createBase64 = function() {
            ...
            return new a(function(e) {
                c.oldAndroid || c.mQQBrowser || !navigator.userAgent ? !
                function() {
        ...
        r.prototype._getResize = function() {
            ...
            for (r && i ? s >= r / i ? a.width > r && (a.width = r, a.height = Math.ceil(r / s)) : a.height > i && (a.height = i, a.width = Math.ceil(i * s)) : r ? r < a.width && (a.width = r, a.height = Math.ceil(r / s)) : i && i < a.height && (a.width = Math.ceil(i * s), a.height = i); a.width >= 3264 || a.height >= 2448;) a.width *= .8,
            a.height *= .8;
            return a
        },
