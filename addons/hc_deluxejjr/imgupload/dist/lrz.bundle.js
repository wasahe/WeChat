...
function() {
    return function(e) {
            ...
            return new a(function(i) {
                try {
                    ...
                    function() {
                        ...
                        l.oldIOS ? e._createBase64ForOldIOS().then(i) : e._createBase64().then(i)
                    })
                } catch(o) {
                    throw new Error(o)
                }
        ...
        r.prototype._createBase64 = function() {
            ...
            return new a(function(e) {
                l.oldAndroid || l.mQQBrowser || !navigator.userAgent ? n.e(2,
                function(t) {
    ...
    function(e, t, n) { (function(t) { !
            function(n) {
                ...
                function i(e) {
                    ...
                    this._value = null,
                    this._deferreds = [],
                    c(e, r(a, this), r(s, this))
                }
                function o(e) {
                    var t = this;
                    return null === this._state ? void this._deferreds.push(e) : void d(function() {
    ...
    function(e, t, n) {
        var r, i; (function() {
            ...
            function c(e, t, n) {
                for (var r, i, o, a, s, u = new DataView(e), l = {},
                c = t; t + n > c;) 28 === u.getUint8(c) && 2 === u.getUint8(c + 1) && (a = u.getUint8(c + 2), a in b && (o = u.getInt16(c + 3), s = o + 5, i = b[a], r = h(u, c + 5, o), l.hasOwnProperty(i) ? l[i] instanceof Array ? l[i].push(r) : l[i] = [l[i], r] : l[i] = r)),
                c++;
                return l
            }
            ...
            function f(e, t, n, r, i) {
                var o, a, s, u, l, c, d = e.getUint16(t + 2, !i),
                f = e.getUint32(t + 4, !i),
                ...
                case 7:
                    ...
                    for (o = f > 4 ? g: t + 8, a = [], u = 0; f > u; u++) a[u] = e.getUint8(o + u);
                    return a;
                case 2:
                    return o = f > 4 ? g: t + 8,
                    h(e, o, f - 1);
                case 3:
                    ...
                    for (o = f > 2 ? g: t + 8, a = [], u = 0; f > u; u++) a[u] = e.getUint16(o + 2 * u, !i);
                    return a;
                case 4:
                    if (1 == f) return e.getUint32(t + 8, !i);
                    for (a = [], u = 0; f > u; u++) a[u] = e.getUint32(g + 4 * u, !i);
                    return a;
                case 5:
                    if (1 == f) return l = e.getUint32(g, !i),
                    c = e.getUint32(g + 4, !i),
                    s = new Number(l / c),
                    s.numerator = l,
                    s.denominator = c,
                    s;
                    for (a = [], u = 0; f > u; u++) l = e.getUint32(g + 8 * u, !i),
                    c = e.getUint32(g + 4 + 8 * u, !i),
                    a[u] = new Number(l / c),
                    a[u].numerator = l,
                    a[u].denominator = c;
                    return a;
                case 9:
                    ...
                    for (a = [], u = 0; f > u; u++) a[u] = e.getInt32(g + 4 * u, !i);
                    return a;
                case 10:
                    if (1 == f) return e.getInt32(g, !i) / e.getInt32(g + 4, !i);
                    for (a = [], u = 0; f > u; u++) a[u] = e.getInt32(g + 8 * u, !i) / e.getInt32(g + 4 + 8 * u, !i);
                    return a
                }
            }
            function h(e, t, n) {
            ...
            function g(e, t) {
                ...
                !1;
                if (r = d(e, s, s + u, y, n), r.ExifIFDPointer) {
                    o = d(e, s, s + r.ExifIFDPointer, w, n);
                    for (i in o) {
                        switch (i) {
                        case "LightSource":
                        case "Flash":
                ...
                if (r.GPSInfoIFDPointer) {
                    a = d(e, s, s + r.GPSInfoIFDPointer, v, n);
                    for (i in a) {
                        switch (i) {
                        case "GPSVersionID":
